...
| masters.self\_links | Master instances self links |
| masters.ssh\_user | Deployed masters agent SSH user |
| network.self\_link | DCOS VPC network self link |
...
| private\_agents.self\_links | Private Agent instances self links |
